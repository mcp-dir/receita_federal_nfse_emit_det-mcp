...
Receita Federal NFS-e: Notas Emitida (Detalhes) segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [receita_federal_nfse_emit_det@mcp.ai](mailto:receita_federal_nfse_emit_det@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
